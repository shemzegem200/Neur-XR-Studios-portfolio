...
import at_2 from '../../images/at_2.png';
...
function AssemblyTraining() {
  return (
    <div id="assembly-training" className='outer-container'>
        <div style={{display:'flex', justifyContent:'space-between', marginBottom:'10px'}}>
            <h1>Assembly Training</h1>
            
            <img src={at_1} style={{width:'200px', height:'173px', borderRadius:'0 0 9px 9px'}}/>
        </div>

        <div className='hc-lower-cont'>
            <img src={at_2} alt='healthcar img' style={{borderRadius:'14px', width:'100%'}}/>
            <div>
