...
import myimage1 from '../../images/bike1.png';
import myimage2 from '../../images/bike2.png';

function Bike() {
    return (
        <div id="bike" className='outer-container'>
            <div className='arm-lower-cont'>
                <img src={myimage1} alt='bike img' style={{ borderRadius: '14px', width: '100%' }} />
                <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <h1 style={{ fontSize: '3rem' }}>VR-Bike Assembly</h1>
                    </div>
                    <div style={{
            ...
            <div className='hc-lower-cont'>
                ...
                <img src={myimage2} alt='bike img' style={{ borderRadius: '14px', width: '100%' }} />
            </div>
        </div>
    );
}
