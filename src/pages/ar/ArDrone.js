...
import ar_drone from '../../images/ar_drone.png';

function ArDrone() {
  return (
    <div id="ar-drone" className='outer-container'>
        <div style={{display:'flex', justifyContent:'space-between'}}>
            <h1 style={{marginTop:'60px', fontSize:'3rem'}}>AR-Drone</h1>
        </div>
        ...
        <div className='hc-lower-cont'>
            ...
            <img src={ar_drone} alt='healthcar img' style={{borderRadius:'14px', width:'100%'}}/>
        </div>
    </div>
  )
}
